INSERT INTO filter (filter_name, created_at, archived_at, selection_id)
VALUES ('Filter 1', '2024-03-02', NULL, 1),
       ('Filter 2', '2024-03-02', NULL, 1),
       ('Filter 3', '2024-03-02', NULL, 2),
       ('Filter 4', '2024-03-02', NULL, 3),
       ('Filter 5', '2024-03-02', NULL, 3);
