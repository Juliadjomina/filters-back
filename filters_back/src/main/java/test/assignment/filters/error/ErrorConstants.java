...
public class ErrorConstants {
    ...
    public static final String ERROR_TEXT_CRITERIA_TEXT_NULL = "error.text.criteria.text.null";
    public static final String ERROR_WRONG_CRITERIA_TYPE = "error.wrong.criteria.type";
    public static final String ERROR_NUMBER_CRITERIA_VALUE_NULL = "error.number.criteria.value.null";
    public static final String ERROR_DATE_CRITERIA_VALUE_NULL = "error.date.criteria.value.null";
    public static final String ERROR_TEXT_CRITERIA_VALUE_NULL = "error.text.criteria.value.null";
    ...
    public static final String ERROR_FILTER_NOT_FOUND = "error.filter.not.found";
}
